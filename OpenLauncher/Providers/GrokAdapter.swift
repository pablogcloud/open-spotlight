...
struct GrokAdapter: CLIProviderAdapter {
  ...
  let invocationDisclosure = ProviderInvocationDisclosure(
    summary:
      "Isolated Grok home in plan mode; tools, web, memory, hooks, plugins, MCP, and subagents disabled.",
    launcherDisablesTools: true,
    residualAccess:
      "Open Spotlight shares only Grok's existing OAuth file with the isolated CLI process."
  )
