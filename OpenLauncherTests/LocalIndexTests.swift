...
final class LocalIndexTests: XCTestCase {
  ...
  func testRootPolicyRejectsWholeVolumeSystemAndVolumeRoots() {
    for path in [
      "/", "/System", "/System/Library", "/Library", "/private/var", "/Volumes", "/Volumes/Archive",
    ] {
      XCTAssertNotNil(
    ...
    XCTAssertNil(
      LocalIndexRootPolicy.rejectionReason(
  ...
  func testChunkerCreatesBoundedOverlappingReferences() {
    ...
    let text = (0..<40).map { "Paragraph \($0) contains searchable project details." }.joined(
      separator: "\n\n")
...
private func localIndexTestBase(_ label: String) -> URL {
  FileManager.default.homeDirectoryForCurrentUser
    .appending(
      path: "Library/Application Support/Open Spotlight Test Fixtures", directoryHint: .isDirectory
    )
